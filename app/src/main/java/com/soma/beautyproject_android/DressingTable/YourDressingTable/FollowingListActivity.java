...
public class FollowingListActivity extends AppCompatActivity {
    FollowingListActivity activity;
    ...
    void afterBindingView() {
        ...
        if (adapter == null) {
            adapter = new FollowingListAdapter(new FollowingListAdapter.OnItemClickListener() {
                @Override
...
//        adapter.notifyDataSetChanged();
    ...
    void connectTestCall_load() {
        ...
        conn.user_loadFollowingUsers(SharedManager.getInstance().getMe().id)
