...
public class FollowerListAdapter extends RecyclerView.Adapter<FollowerListAdapter.ViewHolder> {
    ...
    public FollowerListActivity activity;
    private FollowerListAdapter.OnItemClickListener mOnItemClickListener;
    ...
    public FollowerListAdapter(FollowerListAdapter.OnItemClickListener onItemClickListener, Context mContext, FollowerListActivity mActivity) {
    ...
    public FollowerListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_ITEM) {
            ...
            return new FollowerListAdapter.ItemViewHolder(v);
        }
        return null;
    }

    @Override
    public void onBindViewHolder(FollowerListAdapter.ViewHolder holder, final int position) {
        if (holder instanceof FollowerListAdapter.ItemViewHolder) {
            final FollowerListAdapter.ItemViewHolder itemViewHolder = (FollowerListAdapter.ItemViewHolder) holder;
...
//                activity.connectTestCall(activity.brand.name, activity.main_category, activity.sub_category, ++activity.page_num);
    ...
    public class ItemViewHolder extends FollowerListAdapter.ViewHolder {
