 ...
 */
public class SearchAdapterRecommand extends RecyclerView.Adapter<SearchAdapterRecommand.ViewHolder> {
    ...
    public SearchAdapterRecommand(OnItemClickListener onItemClickListener, Context mContext, SearchFragmentBrand mFragment) {
        mOnItemClickListener = onItemClickListener;
        context = mContext;
        fragment = mFragment;
        mDataset.clear();
    }
    public SearchAdapterRecommand(OnItemClickListener onItemClickListener, Context mContext, SearchFragmentCategory mFragment) {
        mOnItemClickListener = onItemClickListener;
        context = mContext;
        fragment = mFragment;
        mDataset.clear();
    }
    public SearchAdapterRecommand(OnItemClickListener onItemClickListener, Context mContext, Activity mActivity) {
        mOnItemClickListener = onItemClickListener;
        context = mContext;
        activity = mActivity;
        mDataset.clear();
    ...
    @Override
     public SearchAdapterRecommand.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
