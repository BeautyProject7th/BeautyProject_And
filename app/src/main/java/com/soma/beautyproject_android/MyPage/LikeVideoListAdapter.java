 ...
 */
public class LikeVideoListAdapter extends RecyclerView.Adapter<LikeVideoListAdapter.ViewHolder> {
    private static final int TYPE_ITEM = 0;

    public Context context;
    public LikeVideoListActivity activity;
    ...
    public LikeVideoListAdapter(OnItemClickListener onItemClickListener, Context mContext, LikeVideoListActivity mActivity) {
