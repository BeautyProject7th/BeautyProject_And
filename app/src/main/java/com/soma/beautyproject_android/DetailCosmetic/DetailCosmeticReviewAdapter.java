...
public class DetailCosmeticReviewAdapter extends RecyclerView.Adapter<DetailCosmeticReviewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        if (holder instanceof ItemViewHolder) {
            ...
            String image_url_user = Constants.IMAGE_BASE_URL_users + review.profile_url;
            ...
            itemViewHolder.TV_expiration_date.setText(review.expiration_date);
            itemViewHolder.TV_purchase_date.setText(review.purchase_date);
    ...
    public class ItemViewHolder extends ViewHolder {
        ...
        public TextView TV_expiration_date,TV_purchase_date,TV_rating,TV_review;
