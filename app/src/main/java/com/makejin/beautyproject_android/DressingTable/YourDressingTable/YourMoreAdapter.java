...
import com.makejin.beautyproject_android.DressingTable.YourDressingTable.YourMoreActivity;
 ...
 */
public class YourMoreAdapter extends RecyclerView.Adapter<YourMoreAdapter.ViewHolder> {
    private static final int TYPE_ITEM = 0;

    public Context context;
    public YourMoreFragment fragment;
    private OnItemClickListener mOnItemClickListener;
    public ArrayList<Cosmetic> mDataset = new ArrayList<>();
    //public final int temp_main_category_num = YourMoreActivity.main_category_num;

    public interface OnItemClickListener {
        void onItemClick(View view, int position);
    }

    public YourMoreAdapter(OnItemClickListener onItemClickListener, Context mContext, YourMoreFragment mFragment) {
    ...
    @Override
     public YourMoreAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        if (holder instanceof ItemViewHolder) {
            ...
            if (position == mDataset.size()-1 && !fragment.endOfPage) {
                ...
                fragment.page_num++;
                fragment.connectTestCall(YourMoreActivity.main_category);
            }
        }
    }
