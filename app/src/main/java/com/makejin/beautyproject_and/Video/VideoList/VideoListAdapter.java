...
public class VideoListAdapter extends RecyclerView.Adapter<VideoListAdapter.ViewHolder> {
    ...
    public VideoListAdapter(OnItemClickListener onItemClickListener, Context mContext, VideoListFragment mFragment) {
    ...
    @Override
     public VideoListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.cell_video_list, parent, false);
